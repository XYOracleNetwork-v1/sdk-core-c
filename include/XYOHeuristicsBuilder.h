...
XYResult* Heuristic_Text_Creator_create(const char id[2], void* user_data);
...
XYResult* ECDSA_secp256k1Uncompressed_creator_create(const char id[2], void* user_data);
...
XYResult* Payload_creator_create(const char id[2], void* user_data);
...
XYResult* ByteStrongArray_creator_create(const char id[2], void* user_data);
...
XYResult* ShortStrongArray_creator_create(const char id[2], void* user_data);
...
XYResult* IntStrongArray_creator_create(const char id[2], void* user_data);
...
XYResult* IntWeakArray_creator_create(const char[2], void* user_data);
...
XYResult* ShortWeakArray_creator_create(const char[2], void* user_data);
...
XYResult* ByteWeakArray_creator_create(const char[2], void* user_data);
