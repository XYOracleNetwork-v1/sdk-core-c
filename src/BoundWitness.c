...
#include "xyo.h"
#include <stdlib.h>
#include "ZigZagBoundWitnessSession.h"      // includes "xyobject.h", "hash.h", <stdint.h>
...
XYResult_t* BoundWitness_creator_fromBytes(char* data){
  ...
  if(!return_BoundWitness) {RETURN_ERROR(ERR_INSUFFICIENT_MEMORY)};           // couldn't create a new crypto creator
