 ...
 *
 * @brief primary short strong array routines for the XYO Core.
 *
...
*
*  PARAMETERS
*     *self_ShortStrongArray  [in]      XYObject_t*
*     *user_XYObject          [in]      ShortStrongArray_t*
*
*  RETURNS
...
*
*  RETURNS
*      XYResult_t*            [out]      bool   Returns XYObject_t* of the ShortStrongArray type.
*----------------------------------------------------------------------------*/
